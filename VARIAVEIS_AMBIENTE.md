...
> ⚠️ **NOTA:** Este documento é do projeto original. Para o **frontend App Atleta**, veja `VARIAVEIS_AMBIENTE_FRONTEND.md`

Este documento lista todas as variáveis de ambiente necessárias para o projeto **original** (backend com banco de dados).
