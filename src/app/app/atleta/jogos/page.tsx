// app/app/atleta/jogos/page.tsx - Meus Jogos do atleta
'use client';
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 py-6 px-4">
      <div className="max-w-6xl mx-auto space-y-6">
        <div className="text-center mb-8">
          <h1 className="text-4xl font-bold text-gray-900 mb-2">Meus Jogos</h1>
        ...
        <>
          ...
          <AtualizarPlacarModal
            ...
            onSuccess={() => {
              setModalPlacar(false);
              setPartidaSelecionada(null);
              carregarPartidas(); // Recarrega a lista de partidas
            }}
          />
